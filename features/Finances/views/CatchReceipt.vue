  ...
  <v-form v-model="valid">
      ...
      <i class="fa fa-pen ml-2" ></i> تعديل/إضافة 
        ...
        <div class="text-right" > <strong>النوع </strong></div>
              ...
              <v-radio label="الدفع اجل" value="3"></v-radio>
              <v-radio label="تحت التحصيل" value="4"></v-radio>
            </v-radio-group>
          </v-col>
          <v-col cols="6" >
            <v-textarea
...
data(){
  return{
    ...
    headers: [
          ...
          { text: 'المودع', value: 'despositor', align: 'center', },
          { text: 'نوع الشاط', value: 'activeTypes', align: 'center', },
          { text: 'النوع ', value: 'paymentType', align: 'center', },
...
async mounted() {
    try {
        this.getData();
         const clients =  await clientsApi.query();
